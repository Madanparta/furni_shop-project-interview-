...
const Dashboard = () => {
    ...
    const adminLongoutHandler = async()=>{
  ...
  return (
    ...
    <aside id="sidebar-multi-level-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul className="space-y-2 font-medium">
                <li>
                    <p onClick={()=>setDashBoardNav('dashboard')} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group cursor-pointer">
                ...
                <li>
                    <p onClick={()=>setDashBoardNav('products')} className="cursor-pointer flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li>
                    <button onClick={()=>{setHiden(!hidden),setDashBoardNav('e_commerce')}} type="button" className="cursor-pointer flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    ...
                    <ul id="dropdown-example" className={`py-2 space-y-2 ${!hidden?'hidden':'block'}`}>
                        <li>
                ...
                <li>
                    <p onClick={()=>setDashBoardNav('users')} className="cursor-pointer flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li onClick={adminLongoutHandler}>
    ...
    <div className="p-4 sm:ml-64">
        {/* pages */}
        {
            dashBoardNav === "dashboard" && <DashboardPage/>
        }
        {
            dashBoardNav === "products" && <ProductPage/>
        }
    </div>
