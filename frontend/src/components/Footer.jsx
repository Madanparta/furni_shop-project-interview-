...
function Footer() {
  ...
  return (
    <footer style={{fontFamily:"Noto Sans"}} className="bg-gray-50 text-black py-12 w-full h-full mt-5">
      <div className="w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex flex-col gap-4">
            ...
            <button className="px-3 py-1 rounded-sm bg-[#91c24c] text-lg text-white tracking-wide">Sign up me!</button>
        </div>
      </div>
    </footer>
  );
