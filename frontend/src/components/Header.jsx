...
const Header = () => {
  return (
    <div className=' h-[100px] w-full flex justify-between items-center px-6 md:px-10 py-1 bg-white shadow-sm shadow-[#1717170a] sticky top-0 left-0'>
        <Logo/>
        ...
        <div className='w-fit h-fit flex justify-center items-center'>
            <input type="text" placeholder='Search...' className='border border-gray-100 px-5 py-1 md:py-2 rounded-l-full w-fit lg:w-[500px] border-r-0'/>
